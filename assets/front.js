...
function soundAdd() {
    const audio = new Audio("./images\\ES_Duffle Bag Drop 1 - SFX Producer.mp3");
    audio.play()
}
function soundRemove() {
    const audio = new Audio("./images\\ES_Jar Remove Lid 2 - SFX Producer.mp3");
    audio.play()
}
function soundUp() {
    const audio = new Audio("./images\\ES_Gun Holster Remove 3 - SFX Producer.mp3");
    audio.play()
}
function soundDown() {
    const audio = new Audio("./images\\ES_Cigarette Remove - SFX Producer.mp3");
    audio.play()
}
function soundPay() {
    const audio = new Audio("./images\\ES_Coins Drop 1 - SFX Producer.mp3");
    audio.play()
}
